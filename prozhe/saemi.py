...
photo = PhotoImage(file="ccc.png")
Label(f1, image=photo).place(x=0, y=0, relwidth=1, relheight=1)

w = Label(f1, text="welcome to this program. you can code by c language", font=("Helvetica", 16),pady=10)
w.pack()
z = Label(f1, text="Choose what you want", font=("Helvetica", 16), pady=30)
z.pack()
...
btnback = Button(f2, text='Go back', bg="black", fg="red", command=lambda: raise_frame(f1)).place(x=630, y=550)
